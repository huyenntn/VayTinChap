        ...
        <div class="wrapper">
            <div class="container">
                <h3 class="rule-vp-h3-admin">
                    <span class="rule-vp-span">Quản lý nội dung trang Vay cá nhân</span>
                </h3>
                <div class="titlesubpage">
                    <div class="rule-vp-h3-admin">
                                <span class="rule-vp-span" id="edittxt48"><%=htmldisplayDAO.getHtmlById(48).getHtmlcode()%></span>
                                <div class="edtcont2">
                                    <a onclick="asd(48)" id="btnsua48" class="btnedthtmltitcon" ><i class="glyphicon glyphicon-pencil " style="font-size: 15px"></i></a>
                                </div>
                                <div class="edt11">
                                    <form id="form48" style="display: none; ">
                                        <textarea name="edt48" id="edt48" ></textarea>
                                        <a class="btna btn btn-default" onclick="show(48)">Cập nhật</a>
                                    </form>
                                </div>
                    </div>
                </div>
                    <div class="rule-vp-row">
                        <h3 class="rule-vp-h3-admin">
                                <span class="rule-vp-span" id="edittxt35"><%=htmldisplayDAO.getHtmlById(35).getHtmlcode()%></span>
                                <div class="edtcont2">
                                    <a onclick="asd(35)" id="btnsua35" class="btnedthtmltitcon" ><i class="glyphicon glyphicon-pencil " style="font-size: 15px"></i></a>
                                </div>
                                <div class="edt11">
                                    <form id="form35" style="display: none; ">
                                        <textarea name="edt35" id="edt35" ></textarea>
                                        <a class="btna btn btn-default" onclick="show(35)">Cập nhật</a>
                                    </form>
                                </div>
                        </h3>     
                        <div class="rule-vp-content-admin">
                            <span id="edittxt36"><%=htmldisplayDAO.getHtmlById(36).getHtmlcode()%></span>
                            <div class="edtcont2">
                                    <a onclick="asd(36)" id="btnsua36" class="btnedthtmltitcon" ><i class="glyphicon glyphicon-pencil "></i></a>
                            </div>
                                <div class="edt11">
                                    <form id="form36" style="display: none; ">
                                        <textarea name="edt36" id="edt36" ></textarea>
                                        <a class="btna btn btn-default" onclick="show(36)">Cập nhật</a>
                                    </form>
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="rule-vp-row infor-vp-row">
                        <h3 class="rule-vp-h3-admin">
                                <span class="rule-vp-span" id="edittxt37"><%=htmldisplayDAO.getHtmlById(37).getHtmlcode()%></span>
                                <div class="edtcont2">
                                    <a onclick="asd(37)" id="btnsua37" class="btnedthtmltitcon" ><i class="glyphicon glyphicon-pencil " style="font-size: 15px"></i></a>
                                </div>
                                <div class="edt11">
                                    <form id="form37" style="display: none; ">
                                        <textarea name="edt37" id="edt37" ></textarea>
                                        <a class="btna btn btn-default" onclick="show(37)">Cập nhật</a>
                                    </form>
                                </div>
                        </h3>  
                        <div class="rule-vp-content-admin" style="display: block;">
                            <span id="edittxt38"><%=htmldisplayDAO.getHtmlById(38).getHtmlcode()%></span>
                            <div class="edtcont2">
                                    <a onclick="asd(38)" id="btnsua38" class="btnedthtmltitcon" ><i class="glyphicon glyphicon-pencil "></i></a>
                                </div>
                                <div class="edt11">
                                    <form id="form38" style="display: none; ">
                                        <textarea name="edt38" id="edt38" ></textarea>
                                        <a class="btna btn btn-default" onclick="show(38)">Cập nhật</a>
                                    </form>
                                </div>
                        </div>
                    </div>
