        ...
        <div class="wrapper">
            <div class="container">
                <h3 class="rule-vp-h3-admin">
                    <span class="rule-vp-span">Quản lý nội dung trang Vay tiểu thương</span>
                </h3>
                <div class="titlesubpage">
                    <div class="rule-vp-h3-admin">
                                <span class="rule-vp-span" id="edittxt49"><%=htmldisplayDAO.getHtmlById(49).getHtmlcode()%></span>
                                <div class="edtcont2">
                                    <a onclick="asd(49)" id="btnsua49" class="btnedthtmltitcon" ><i class="glyphicon glyphicon-pencil " style="font-size: 15px"></i></a>
                                </div>
                                <div class="edt11">
                                    <form id="form49" style="display: none; ">
                                        <textarea name="edt49" id="edt49" ></textarea>
                                        <a class="btna btn btn-default" onclick="show(49)">Cập nhật</a>
                                    </form>
                                </div>
                    </div>
                </div>
                    ...
                    <div class="rule-vp-row">
                        <h3 class="rule-vp-h3-admin">
                                <span class="rule-vp-span" id="edittxt39"><%=htmldisplayDAO.getHtmlById(43).getHtmlcode()%></span>
                                <div class="edtcont2">
                                    <a onclick="asd(43)" id="btnsua43" class="btnedthtmltitcon" ><i class="glyphicon glyphicon-pencil " style="font-size: 15px"></i></a>
                                </div>
                                <div class="edt11">
                                    <form id="form43" style="display: none; ">
                                        <textarea name="edt43" id="edt43" ></textarea>
                                        <a class="btna btn btn-default" onclick="show(43)">Cập nhật</a>
                                    </form>
                                </div>
                        </h3>     
                        <div class="rule-vp-content-admin">
                            <span id="edittxt44"><%=htmldisplayDAO.getHtmlById(44).getHtmlcode()%></span>
                            <div class="edtcont2">
                                    <a onclick="asd(44)" id="btnsua44" class="btnedthtmltitcon" ><i class="glyphicon glyphicon-pencil "></i></a>
                                </div>
                                <div class="edt11">
                                    <form id="form44" style="display: none; ">
                                        <textarea name="edt44" id="edt44" ></textarea>
                                        <a class="btna btn btn-default" onclick="show(44)">Cập nhật</a>
                                    </form>
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="rule-vp-row infor-vp-row">
                        <h3 class="rule-vp-h3-admin">
                                <span class="rule-vp-span" id="edittxt45"><%=htmldisplayDAO.getHtmlById(45).getHtmlcode()%></span>
                                <div class="edtcont2">
                                    <a onclick="asd(45)" id="btnsua45" class="btnedthtmltitcon" ><i class="glyphicon glyphicon-pencil " style="font-size: 15px"></i></a>
                                </div>
                                <div class="edt11">
                                    <form id="form45" style="display: none; ">
                                        <textarea name="edt45" id="edt45" ></textarea>
                                        <a class="btna btn btn-default" onclick="show(45)">Cập nhật</a>
                                    </form>
                                </div>
                        </h3>  
                        <div class="rule-vp-content-admin" style="display: block;">
                            <span id="edittxt46"><%=htmldisplayDAO.getHtmlById(46).getHtmlcode()%></span>
                            <div class="edtcont2">
                                    <a onclick="asd(46)" id="btnsua46" class="btnedthtmltitcon" ><i class="glyphicon glyphicon-pencil "></i></a>
                                </div>
                                <div class="edt11">
                                    <form id="form46" style="display: none; ">
                                        <textarea name="edt46" id="edt46" ></textarea>
                                        <a class="btna btn btn-default" onclick="show(46)">Cập nhật</a>
                                    </form>
                                </div>
                        </div>
                    </div>
