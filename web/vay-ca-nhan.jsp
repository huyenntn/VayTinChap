	...
	<div class="container">	
      ...
      <div class="menu-top">
	    <div class="navid">
            ...
            <div class="item-link active"><a href="vay-ca-nhan.jsp"><%=typelist.get(1).getTypedealName() %></a></div>
...
<div class="body-right">
	<div class="form-register-vp">
        <h2 class="form-register-h2">
    	    <%=htmldisplayDAO.getHtmlById(48).getHtmlcode()%>
    	</h2>
...
<div class="body-center">
    ...
    <div class="rule-vp-row">
    	<h3 class="rule-vp-h3">
        	<span class="rule-vp-span"><%=htmldisplayDAO.getHtmlById(35).getHtmlcode()%></span>
            <a class="rule-sp-more">Xem chi tiết</a>	
        </h3>
        <div class="rule-vp-content">
            <%=htmldisplayDAO.getHtmlById(36).getHtmlcode()%>
        </div>
    </div>
    
    <div class="rule-vp-row infor-vp-row">
    	<h3 class="rule-vp-h3">
        	<span class="rule-vp-span"><%=htmldisplayDAO.getHtmlById(37).getHtmlcode()%></span>
            <a class="rule-sp-more">Xem chi tiết</a>	
        </h3>
        <div class="rule-vp-content" style="display: block;">
            <%=htmldisplayDAO.getHtmlById(38).getHtmlcode()%>
        </div>
    </div>
