<%-- 
    Document   : customerMothe
    Created on : 19-Jul-2017, 00:58:58
    Author     : Ngoc
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function confirmChange(customerId) {
                window.location = 'updateEmployeeSupportMothe.jsp?customerId='+customerId+'&employeeId='+document.getElementById("dropDownId"+customerId).value;
            }
        </script>
    </head>
    <body>
        ...
        <div class="container">
            <h3 class="rule-vp-h3-admin">
                <span class="rule-vp-span">Quản lý khách hàng đăng ký Mở thẻ</span>
            </h3>
