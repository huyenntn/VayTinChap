<%-- 
    Document   : hotline
    Created on : 25-Jul-2017, 14:11:30
    Author     : Ngoc
--%>
        ...
        <div class="wrapper">
            <div class="container">
                <h3 class="rule-vp-h3-admin">
                    <span class="rule-vp-span">Quản lý số điện thoại liên hệ</span>
                </h3>
                <form method="POST">
                    <div class="table-responsive">
                    <table >
                        <tr>
                            <td class="inputtable"><label>Số điện thoại mới</label></td>
                            <td class="inputtable"><input type="text" name="hotline" class="form-control"/></td>
                        </tr>
                        <tr>
                ...
                <%
                    ...
                    try{
                         int hotlinenumber = Integer.parseInt(request.getParameter("hotline"));
                         hotlineDAO.updateHotline(1, hotlinenumber);
                    }catch(Exception ex){
                        
                    }
                    int hotline = hotlineDAO.getHotlineById(1).getHotlineNumber();
                %>
                <table class="table table-bordered table-striped table-hover" style="width: 30%; margin-top: 30px;">
                    <thead>
                        <tr>
