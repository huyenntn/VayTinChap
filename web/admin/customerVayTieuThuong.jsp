    ...
    <head>
        ...
        <script language="javascript">
            function confirmChange(customerId) {
                window.location = 'updateEmployeeSupportVayTieuThuong.jsp?customerId='+customerId+'&employeeId='+document.getElementById("dropDownId"+customerId).value;
            }
        </script>
    </head>
    <body>
        ...
        <div class="container">
            <h3 class="rule-vp-h3-admin">
                <span class="rule-vp-span">Quản lý khách hàng đăng ký Vay tiểu thương</span>
            </h3>
            <div class="tblcontent">
                <form action="updateEmployeeSupportVayTieuThuong.jsp">
                    <%
